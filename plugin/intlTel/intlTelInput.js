 ...
 ********************/
    ...
    //    Area codes
    // ]
    // var allCountries = [["China（中国）", "cn", "86"],["Kazakhstan（俄罗斯）", "kz", "7"],["India（印度）", "in", "91"],["United States（美国）", "us", "1"], ["Indonesia（印度尼西亚）", "id", "62"],["Iran（伊朗）","ir","98"],["Saudi Arabia（沙特）", "sa", "966"], ["Oman（阿曼）", "om", "968"],["Cameroon（）", "cm", "237"]];

    var allCountries = [["China（中国）", "cn", "86"],["Kazakhstan（俄罗斯）", "kz", "007"],["India（印度）", "in", "91"],["United States（美国）", "us", "001"], ["Indonesia（印度尼西亚）", "id", "62"],["Iran（伊朗）","ir","98"],["Saudi Arabia（沙特）", "sa", "966"], ["Oman（阿曼）", "om", "968"],["Cameroon（喀麦隆）", "cm", "237"],["委内瑞拉", "ve", "58"],["危地马拉", "gt", "502"],[ "Hong Kong (中国香港)", "hk", "852" ],[ "Macau (中国澳门)", "mo", "853" ], [ "Taiwan (中国台湾)", "tw", "886" ]];
